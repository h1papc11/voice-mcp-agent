...
import { TOKEN_CONTRACT_ADDRESS, TOKEN_PUMP_URL, TOKEN_TICKER } from '@/lib/constants';
      ...
      <div className="relative mx-auto max-w-4xl px-6">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            The official {TOKEN_TICKER} token for supporters who want to back the project and have
            some fun. Voicebox is and always will be{' '}
            <b className="text-foreground">free and open source</b> — the token is entirely optional
            and not required to use anything here.
          </p>
        </div>
