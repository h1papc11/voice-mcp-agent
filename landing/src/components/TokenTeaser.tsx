      ...
      <div className="mx-auto max-w-4xl px-6">
        <div className="relative flex flex-col items-center gap-5 overflow-hidden rounded-2xl border border-border bg-card/40 backdrop-blur-sm px-6 py-10 text-center">
          ...
          <p className="max-w-xl text-muted-foreground">
            An optional way to back the project and have some fun. Voicebox is and always will be{' '}
            <b className="text-foreground">free and open source</b> — the token is not required to
            use anything here.
          </p>
