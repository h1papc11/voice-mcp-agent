import { Check, Cloud, Heart, Rocket, ShieldCheck } from 'lucide-react';
          ...
          <div className="mx-auto max-w-3xl px-6">
            <div className="text-center mb-12">
              ...
              <p className="text-muted-foreground max-w-2xl mx-auto mt-4">
                Voicebox grew to over a million downloads with zero marketing — but donations alone
                never made full-time work sustainable. {TOKEN_TICKER} changed that overnight, and
                it's already accelerating everything below. The app stays{' '}
                <b className="text-foreground">free, open source, and local-first</b> — forever.
              </p>
            </div>
          ...
          <div className="mx-auto max-w-3xl px-6">
            <div className="rounded-2xl border-2 border-accent/40 bg-card/60 backdrop-blur-sm p-8 md:p-10 shadow-[0_8px_40px_hsl(43_60%_50%/0.08)]">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Encrypted cloud backup and sync (and the mobile cloud) will be a paid service —
                roughly <b className="text-foreground">$12/year</b> for everyone else, and{' '}
                <b className="text-foreground">free for {TOKEN_TICKER} holders</b>. Generate on the
                go, keep your captures and generations safe, and pick up on any device.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="mx-auto max-w-3xl px-6">
            <div className="rounded-2xl border border-border bg-card/40 backdrop-blur-sm p-8">
              ...
              <ul className="space-y-3">
                <ProofRow
                  text={`${TOKEN_TICKER} is the only official Voicebox token. The mint address on this page is the single source of truth — always verify it.`}
                />
        ...
        <section className="border-t border-border py-20">
          <div className="mx-auto max-w-3xl px-6">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              {FAQ.map((item) => (
                <div
                  ...
                  className="rounded-xl border border-border bg-card/40 backdrop-blur-sm p-6"
                >
                  <h3 className="text-[15px] font-semibold text-foreground mb-2">{item.q}</h3>
            ...
            <p className="text-center text-xs text-muted-foreground/70 mt-10 max-w-2xl mx-auto">
              {TOKEN_TICKER} is a community token with no affiliation to any exchange or financial
              product. Nothing on this page is financial advice. Verify the contract address before
              buying.
            </p>
          </div>
        </section>
