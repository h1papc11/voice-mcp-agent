      ...
      <section className="relative pt-32 pb-16">
        ...
        <div className="relative mx-auto max-w-4xl px-6 text-center">
          ...
          <p className="fade-in mx-auto mt-6 max-w-2xl text-lg text-muted-foreground md:text-xl">
            Optional, end-to-end encrypted backup and sync for your entire Voicebox library. We
            can't read a byte of it — only your devices can. Free for{' '}
        ...
        <div className="mx-auto max-w-3xl px-6">
          <div className="rounded-2xl border-2 border-accent/40 bg-card/60 backdrop-blur-sm p-8 md:p-10 text-center shadow-[0_8px_40px_hsl(43_60%_50%/0.08)]">
            ...
            <p className="text-muted-foreground leading-relaxed max-w-2xl mx-auto">
              Voicebox is local-first and privacy-first. The cloud keeps that promise: your library
              is encrypted before it leaves your device, the server stores only ciphertext, and the
              keys never leave your control. Same philosophy as the app — just backed up.
            </p>
