      ...
      <section className="relative pt-32 pb-12">
        ...
        <div className="relative mx-auto max-w-4xl px-6 text-center">
          ...
          <p className="fade-in mx-auto mt-6 max-w-2xl text-lg text-muted-foreground">
            Everything that makes Voicebox great runs locally at no cost. Pay only if you want
            optional, encrypted cloud backup & sync — and holders get that free.
          </p>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-3xl px-6">
          ...
          >
            ...
            <p className="max-w-xl text-sm text-muted-foreground">
              The token is an optional way to back the project — and holders get the Cloud tier at
              no cost. Learn how it works and verify everything on-chain.
            </p>
